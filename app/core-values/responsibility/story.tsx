...
const interactiveElements = [
  { id: 1, x: 0.6, y: 0.5, animation: 'bounce', sound: 'tap', message: 'This is Sammy the Squirrel!' },
  { id: 2, x: 0.4, y: 0.6, animation: 'pulse', sound: 'tap', message: 'Collecting nuts is important!' },
  { id: 3, x: 0.7, y: 0.4, animation: 'shake', sound: 'tap', message: 'Sammy loves to play!' },
  { id: 4, x: 0.5, y: 0.5, animation: 'spin', sound: 'tap', message: 'Ollie is giving good advice!' },
  { id: 5, x: 0.3, y: 0.6, animation: 'pulse', sound: 'tap', message: 'Sammy isn\'t listening...' },
  { id: 6, x: 0.7, y: 0.4, animation: 'bounce', sound: 'tap', message: 'The weather is changing!' },
  { id: 7, x: 0.5, y: 0.5, animation: 'spin', sound: 'tap', message: 'Sammy is worried now!' },
  { id: 8, x: 0.3, y: 0.6, animation: 'shake', sound: 'tap', message: 'Hard work pays off!' },
  { id: 9, x: 0.6, y: 0.4, animation: 'bounce', sound: 'tap', message: 'Just in time for winter!' },
  { id: 10, x: 0.5, y: 0.3, animation: 'pulse', sound: 'tap', message: 'Being responsible helps everyone!' },
];

// Story content
const storyPages = [
  { id: 1, imageSource: require('../../../assets/images/story-squirrel-tree.jpg'), text: "Sammy the Squirrel lived in a cozy tree house with his family in the middle of Sunshine Forest.", duration: 6000 },
  { id: 2, imageSource: require('../../../assets/images/story-squirrel-nuts.jpg'), text: "Every day, Sammy's parents reminded him to collect and store nuts for the winter. 'It's your responsibility,' they said.", duration: 7000 },
  { id: 3, imageSource: require('../../../assets/images/story-squirrel-playing.jpg'), text: "But Sammy loved to play with his friends more than anything. 'I'll collect nuts tomorrow,' he would say, and then run off to play.", duration: 7000 },
  { id: 4, imageSource: require('../../../assets/images/story-squirrel-reminder.jpg'), text: "His friend Ollie Owl warned him, 'Winter is coming soon. Don't you think you should start collecting nuts now?'", duration: 6000 },
  { id: 5, imageSource: require('../../../assets/images/story-squirrel-ignoring.jpg'), text: "'There's plenty of time,' Sammy replied. 'I want to have fun while the weather is still nice!'", duration: 7000 },
  { id: 6, imageSource: require('../../../assets/images/story-weather-changing.jpg'), text: "But soon, the leaves began to change color, and the air grew colder. Winter was coming much faster than Sammy expected.", duration: 6000 },
  { id: 7, imageSource: require('../../../assets/images/story-squirrel-worried.jpg'), text: "Sammy looked at his nearly empty food storage and felt worried. 'Oh no! I've waited too long. What am I going to do now?'", duration: 7000 },
  { id: 8, imageSource: require('../../../assets/images/story-squirrel-working.jpg'), text: "Sammy decided he needed to work extra hard. He woke up early every morning and collected nuts until sunset. It was difficult, but he didn't give up.", duration: 8000 },
  { id: 9, imageSource: require('../../../assets/images/story-winter-arrived.jpg'), text: "Just as the first snow began to fall, Sammy filled his storage with enough nuts for the winter. He was exhausted but proud of himself.", duration: 7000 },
  { id: 10, imageSource: require('../../../assets/images/story-responsibility-message.jpg'), text: "Responsibility means doing what needs to be done, even when you'd rather do something else. Being responsible helps you take care of yourself and others!", duration: 9000 },
];

export default function ResponsibilityStoryMobile() {
  ...
  const markStoryAsCompleted = async () => {
    try {
      ...
      console.log('Responsibility story marked as completed');
    } catch (error) {
  ...
  if (isLoading) {
    return (
      <View style={styles.loadingContainer}>
        ...
        >
          <Image 
            source={require('../../../assets/images/story-squirrel-tree.jpg')} 
            style={styles.loadingImage} 
          />
        </Animated.View>
        <ActivityIndicator size="large" color="#FF9052" />
        <Text style={styles.loadingText}>Getting story ready...</Text>
        <Text style={styles.loadingSubtext}>A tale about responsibility awaits!</Text>
      </View>
    );
  }
      ...
      <SafeAreaView style={styles.completionContainer}>
        ...
        >
          ...
          <Text style={styles.completionText}>
            You've learned about the importance of responsibility! 
            Doing what needs to be done helps you and everyone around you!
          </Text>
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push('/core-values/responsibility')}
            activeOpacity={0.8}
          >
            <LinearGradient
              colors={['#FF9052', '#E07735']}
            ...
            >
              <Text style={styles.completionButtonText}>Back to Responsibility Lessons</Text>
            </LinearGradient>
          </TouchableOpacity>
        </Animated.View>
      </SafeAreaView>
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.headerContent}>
          <View style={styles.headerTextContainer}>
            <Text style={styles.title}>The Responsible Squirrel</Text>
      ...
      <Animated.View style={[styles.contentArea, pageAnimatedStyle]}>
            ...
            <View style={styles.imageContainer}>
              {imageError ? (
                <View style={styles.placeholderContainer}>
                  <Ionicons name="image-outline" size={60} color="#FF9052" />
        ...
        <Animated.View style={[styles.textWrapper, textAnimatedStyle]}>
          <LinearGradient
            colors={['rgba(255,255,255,0.95)', 'rgba(255,240,230,0.95)']}
      ...
      <View style={styles.controlsWrapper}>
        ...
        >
          <LinearGradient
            colors={currentPage === 0 ? ['#bdbdbd', '#9e9e9e'] : ['#FF9052', '#E07735']}
        ...
        >
          <LinearGradient
            colors={currentPage === storyPages.length - 1 ? ['#bdbdbd', '#9e9e9e'] : ['#FF9052', '#E07735']}
            style={styles.navButtonGradient}
          >
...
const styles = StyleSheet.create({
  ...
  webTapHere: {
    ...
    height: 40,
    borderRadius: 20,
    backgroundColor: 'rgba(236, 227, 221, 0.7)',
    justifyContent: 'center',
    alignItems: 'center',
    borderWidth: 2,
    borderColor: '#FFF',
