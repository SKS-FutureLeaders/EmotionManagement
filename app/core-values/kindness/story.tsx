...
const interactiveElements = [
  { id: 1, x: 0.7, y: 0.5, animation: 'bounce', sound: 'tap', message: 'This is Hoppy the Bunny!' },// tap sound reduce
  { id: 2, x: 0.3, y: 0.6, animation: 'pulse', sound: 'tap', message: 'The fox is feeling sad' },
  { id: 3, x: 0.6, y: 0.3, animation: 'shake', sound: 'tap', message: 'The animals are hiding!' },
  { id: 4, x: 0.4, y: 0.4, animation: 'spin', sound: 'tap', message: 'Hoppy is thinking...' },
  { id: 5, x: 0.7, y: 0.7, animation: 'pulse', sound: 'tap', message: 'Hoppy is being brave!' },
  { id: 6, x: 0.5, y: 0.5, animation: 'bounce', sound: 'tap', message: 'Rusty is talking' },
  { id: 7, x: 0.3, y: 0.6, animation: 'spin', sound: 'tap', message: 'Sharing is caring!' },
  { id: 8, x: 0.6, y: 0.4, animation: 'shake', sound: 'tap', message: 'Everyone\'s making friends!' },
  { id: 9, x: 0.5, y: 0.3, animation: 'bounce', sound: 'tap', message: 'Best friends forever!' },
  { id: 10, x: 0.4, y: 0.2, animation: 'pulse', sound: 'tap', message: 'Kindness makes everyone happy!' },
];

// Story content with enhanced descriptions for TTS
const storyPages = [
  { id: 1, imageSource: require('../../../assets/images/story-bunny-meadow.jpeg'), text: "Once upon a time, there was a happy bunny named Hoppy who lived in a beautiful meadow.", duration: 5000 },
  { id: 2, imageSource: require('../../../assets/images/story-sad-fox.jpg'), text: "One day, Hoppy noticed a small fox sitting alone under a tree. The fox looked very sad.", duration: 7000 },
  { id: 3, imageSource: require('../../../assets/images/story-animals-hiding.jpg'), text: "None of the other animals played with the fox. They were all hiding because they were afraid of him.", duration: 6000 },
  { id: 4, imageSource: require('../../../assets/images/story-thinking-bunny.jpg'), text: "Hoppy felt sorry for the fox. 'Everyone needs a friend,' thought Hoppy. 'I should try to be kind.'", duration: 7000 },
  { id: 5, imageSource: require('../../../assets/images/story-bunny-approaches-fox.jpg'), text: "So Hoppy hopped over to the fox, even though he felt a little scared. 'Hello,' said Hoppy. 'My name is Hoppy. What's your name?'", duration: 9000 },
  { id: 6, imageSource: require('../../../assets/images/story-fox-talking.jpg'), text: "'I'm Rusty,' said the fox. 'Nobody wants to play with me because I'm a fox. They think I'll eat them.'", duration: 7000 },
  { id: 7, imageSource: require('../../../assets/images/story-sharing-carrot.jpg'), text: "'I don't think you'll eat me,' said Hoppy with a smile. 'Would you like to share my carrot?'", duration: 6000 },
  { id: 8, imageSource: require('../../../assets/images/story-animals-together.jpg'), text: "When the other animals saw that Rusty was friendly, they came out to meet him too. Rusty wasn't lonely anymore.", duration: 7000 },
  { id: 9, imageSource: require('../../../assets/images/story-friends-playing.jpg'), text: "Hoppy and Rusty became best friends, and they played together every day.", duration: 5000 },
  { id: 10, imageSource: require('../../../assets/images/story-final-message.jpg'), text: "Being kind to others, especially when they're sad or alone, can make a big difference in their lives. And you might make a new friend too!", duration: 9000 },
];

export default function KindnessStoryMobile() {
  ...
  useEffect(() => {
    if (soundsLoaded && backgroundSound && !isLoading) {
  ...
  if (isLoading) {
    return (
      <View style={styles.loadingContainer}>
        ...
        >
          <Image 
            source={require('../../../assets/images/loading-bunny.jpeg')} 
            style={styles.loadingImage} 
          />
        </Animated.View>
        <ActivityIndicator size="large" color="#9C27B0" />
        <Text style={styles.loadingText}>Getting story ready...</Text>
        <Text style={styles.loadingSubtext}>A magical adventure awaits!</Text>
      </View>
    );
  }

  // Completion screen with celebration effects
  // Only modify the story completion section - around line 383
...
if (storyCompleted) {
  return (
    <SafeAreaView style={styles.completionContainer}>
      ...
      >
        <LinearGradient
          colors={['#9C27B0', '#7E57C2']}
          style={styles.completionHeader}
        >
          <Text style={styles.completionHeaderText}>Amazing Job!</Text>
        </LinearGradient>
        ...
        <Text style={styles.completionText}>
          You've learned about the power of kindness! 
          Being kind to others makes everyone's day better!
        </Text>
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push('/core-values/kindness')}
          activeOpacity={0.8}
        >
          <LinearGradient
          ...
          >
            <Text style={styles.completionButtonText}>Back to Kindness Lessons</Text>
          </LinearGradient>
        </TouchableOpacity>
      </Animated.View>
    </SafeAreaView>
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.headerContent}>
          <View style={styles.headerTextContainer}>
            <Text style={styles.title}>The Kind Bunny</Text>
          ...
          <Animated.Image
            source={require('../../../assets/images/bunny-guide.jpeg')}
      ...
      <Animated.View style={[styles.contentArea, pageAnimatedStyle]}>
            ...
            <View style={styles.imageContainer}>
              {imageError ? (
                <View style={styles.placeholderContainer}>
                  <Ionicons name="image-outline" size={60} color="#9C27B0" />
        ...
        <Animated.View style={[styles.textWrapper, textAnimatedStyle]}>
          <LinearGradient
            colors={['rgba(255,255,255,0.95)', 'rgba(243,229,245,0.95)']}
      ...
      <View style={styles.controlsWrapper}>
        ...
        >
          <LinearGradient
            colors={currentPage === 0 ? ['#bdbdbd', '#9e9e9e'] : ['#9C27B0', '#7E57C2']}
        ...
        >
          <LinearGradient
            colors={currentPage === storyPages.length - 1 ? ['#bdbdbd', '#9e9e9e'] : ['#9C27B0', '#7E57C2']}
            style={styles.navButtonGradient}
          >
...
webTapHere: {
  ...
  height: 40,
  borderRadius: 20,
  backgroundColor: 'rgba(197, 190, 199, 0.7)',
  justifyContent: 'center',
  alignItems: 'center',
  borderWidth: 2,
  borderColor: '#FFF',
